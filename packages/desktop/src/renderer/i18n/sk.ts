export const dict = {
  ...
  "desktop.updater.none.message": "Používate najnovšiu verziu Caimex Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzia {{version}} Caimex Code bola stiahnutá. Chcete ju nainštalovať a reštartovať?",
  ...
  "desktop.cli.installed.message":
    "CLI bolo nainštalované do {{path}}\n\nReštartujte terminál, aby ste mohli používať príkaz 'caimex'.",
