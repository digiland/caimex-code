export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የCaimex Code ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከCaimex Code ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
