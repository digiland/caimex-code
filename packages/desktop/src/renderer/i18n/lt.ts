export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią Caimex Code versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "Caimex Code versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
  ...
  "desktop.cli.installed.message":
    "CLI įdiegtas į {{path}}\n\nIš naujo paleiskite terminalą, kad galėtumėte naudoti komandą 'caimex'.",
