export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Caimex Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Caimex Code versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
  ...
  "desktop.cli.installed.message":
    "CLI terinstal di {{path}}\n\nMulai ulang terminal Anda untuk menggunakan perintah 'caimex'.",
