export const dict = {
  ...
  "desktop.updater.none.message": "Artıq Caimex Code-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "Caimex Code-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'caimex' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
