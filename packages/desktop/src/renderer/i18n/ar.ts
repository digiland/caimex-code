export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Caimex Code",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من Caimex Code. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
