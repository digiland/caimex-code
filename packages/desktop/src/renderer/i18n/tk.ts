export const dict = {
  ...
  "desktop.updater.none.message": "Caimex Code-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Caimex Code-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'caimex' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
