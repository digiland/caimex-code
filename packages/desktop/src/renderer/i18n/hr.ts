export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Caimex Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Caimex Code. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI instaliran na {{path}}\n\nPonovno pokrenite terminal da biste koristili naredbu 'caimex'.",
