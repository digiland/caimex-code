export const dict = {
  ...
  "desktop.updater.none.message": "Már az Caimex Code legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Caimex Code {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
  ...
  "desktop.cli.installed.message":
    "A CLI telepítési helye: {{path}}\n\nIndítsa újra a terminált az 'caimex' parancs használatához.",
