export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Caimex Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Caimex Code. Czy chcesz ją zainstalować i uruchomić ponownie?",
