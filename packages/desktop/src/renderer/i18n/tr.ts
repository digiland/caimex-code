export const dict = {
  ...
  "desktop.updater.none.message": "Caimex Code'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Caimex Code'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'caimex' komutunu kullanmak için terminalinizi yeniden başlatın.",
