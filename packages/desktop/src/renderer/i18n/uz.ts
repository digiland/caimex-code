export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon Caimex Code ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "Caimex Codening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'caimex' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
