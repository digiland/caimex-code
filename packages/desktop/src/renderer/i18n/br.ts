export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Caimex Code",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Caimex Code foi baixada. Você gostaria de instalá-la e reiniciar?",
