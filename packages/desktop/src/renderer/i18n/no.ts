export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Caimex Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Caimex Code er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert i {{path}}\n\nStart terminalen på nytt for å bruke 'caimex'-kommandoen.",
