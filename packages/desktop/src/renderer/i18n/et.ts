export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Caimex Code uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Caimex Code'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
