export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Caimex Code-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Caimex Code-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
