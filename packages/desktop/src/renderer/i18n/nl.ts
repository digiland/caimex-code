export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Caimex Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Caimex Code is gedownload. Wil je deze installeren en Caimex Code opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'caimex' te gebruiken.",
