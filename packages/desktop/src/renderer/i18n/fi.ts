export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Caimex Coden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Caimex Coden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Caimex Coden uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'caimex'-komentoa.",
