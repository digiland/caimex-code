...
const TIPS: Tip[] = [
  ...
  "Create {highlight}caimex.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in {highlight}~/.config/caimex-code/tui.json{/highlight} for global config",
  ...
  "Run {highlight}caimex serve{/highlight} for headless API access to Caimex Code",
  "Use {highlight}caimex run --attach{/highlight} to connect to a running server",
  "Run {highlight}caimex upgrade{/highlight} to update to the latest version",
  "Run {highlight}caimex auth list{/highlight} to see all configured providers",
  "Run {highlight}caimex agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}caimex github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}caimex debug config{/highlight} to troubleshoot configuration",
