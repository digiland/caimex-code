export const dict = {
  ...
  "desktop.recovery.loadFailed": "Caimex Code መጫን አልቻለም",
  "desktop.recovery.terminated": "Caimex Code መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Caimex Code ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Codeመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Caimex Code ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በCaimex Code ይጠቀሙ።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በCaimex Code ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በCaimex Code ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ caimex.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Caimex Code አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Caimex Codeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Caimex Code በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Caimex Code በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "Caimex Code ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Caimex Code በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Codeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Caimex Code WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Caimex Code።",
  ...
  "help.tabs.introduction": "Caimex Code ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የCaimex Code ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለCaimex Code ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (caimex.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Caimex Code እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "Caimex Code ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የCaimex Code አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለCaimex Code",
  ...
  "settings.general.row.appearance.description": "Caimex Codeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Caimex Code ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Caimex Code ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Caimex Code ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የCaimex Code እትም እያሄዱ ነው።",
