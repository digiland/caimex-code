export const dict = {
  ...
  "desktop.menu.documentation": "Документація Caimex Code",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Caimex Code",
  "desktop.recovery.terminated": "Роботу вікна Caimex Code несподівано завершено",
  "desktop.recovery.unresponsive": "Caimex Code не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити Caimex Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Caimex Code завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Caimex Code.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в caimex.json",
  ...
  "dialog.server.description": "Перемкніть сервер Caimex Code, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Caimex Code у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Caimex Code у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Caimex Code у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Caimex Code у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Caimex Code потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Caimex Code ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Caimex Code",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (caimex.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Caimex Code ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Caimex Code всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Caimex Code",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Caimex Code на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Caimex Code використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Caimex Code",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Caimex Code.",
