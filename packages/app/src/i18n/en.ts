...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Caimex Code.",
  ...
  "dialog.plugins.empty": "Plugins configured in caimex.json",
  ...
  "dialog.server.description": "Switch which Caimex Code server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Caimex Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Caimex Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Caimex Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Caimex Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Caimex Code can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Caimex Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Caimex Code team",
  ...
  "error.chain.checkConfig": "Check your config (caimex.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Caimex Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Caimex Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Caimex Code",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Caimex Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Caimex Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Caimex Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Caimex Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Caimex Code.",
