export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Caimex Code",
  ...
  "desktop.recovery.loadFailed": "Caimex Code gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Caimex Code ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Caimex Code tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Caimex Code gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Caimex Code selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Caimex Code.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam caimex.json",
  ...
  "dialog.server.description": "Tukar pelayan Caimex Code yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Caimex Code dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Caimex Code dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Caimex Code dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Caimex Code dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Caimex Code boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Caimex Code ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Caimex Code",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (caimex.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Caimex Code belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Caimex Code dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Caimex Code",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Caimex Code pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Caimex Code mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Caimex Code dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Caimex Code.",
