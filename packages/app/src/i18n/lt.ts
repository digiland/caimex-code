...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Caimex Code.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti caimex.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Caimex Code serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Caimex Code {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Caimex Code {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Caimex Code {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Caimex Code į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Caimex Code galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Caimex Code ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Caimex Code komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (caimex.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Caimex Code dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Caimex Code apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Caimex Code darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Caimex Code serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Caimex Code ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Caimex Code atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Caimex Code seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Caimex Code temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Caimex Code",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Caimex Code versiją.",
