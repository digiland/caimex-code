export const dict = {
  ...
  "desktop.menu.documentation": "Caimex Code Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Caimex Code ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Caimex Code se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Caimex Code se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Caimex Code ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Caimex Code je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Caimex Code.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v caimex.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Caimex Code se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Caimex Code ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Caimex Code v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Caimex Code ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Caimex Code v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Caimex Code v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Caimex Code v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Caimex Code doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Caimex Code ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Caimex Code",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (caimex.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Caimex Code še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Caimex Code znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Caimex Code",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Caimex Code izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Caimex Code sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Caimex Code",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Caimex Code.",
