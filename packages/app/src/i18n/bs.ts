export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Caimex Code",
  ...
  "desktop.menu.ariaLabel": "Caimex Code meni",
  ...
  "desktop.recovery.loadFailed": "Caimex Code se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Caimex Code-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Caimex Code ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Caimex Code-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Caimex Code-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Caimex Code-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Caimex Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Caimex Code-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u caimex.json",
  ...
  "dialog.server.description": "Promijeni na koji se Caimex Code server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Caimex Code u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Caimex Code u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Caimex Code u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Caimex Code u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Caimex Code mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Caimex Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Caimex Code timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (caimex.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Caimex Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Caimex Code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Caimex Code-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Caimex Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Caimex Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Caimex Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Caimex Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Caimex Code-a.",
