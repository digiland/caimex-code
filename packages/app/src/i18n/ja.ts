export const dict = {
  ...
  "desktop.recovery.loadFailed": "Caimex Codeを読み込めませんでした",
  "desktop.recovery.terminated": "Caimex Codeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Caimex Codeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Codeのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはCaimex Codeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Caimex Codeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Caimex Codeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCaimex Codeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Caimex Codeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "caimex.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するCaimex Codeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Caimex Codeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のCaimex Codeを確認中...",
  "wsl.onboarding.updatingOpencode": "Caimex Codeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のCaimex Codeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のCaimex Codeを更新してください。",
  "wsl.onboarding.updateOpencode": "Caimex Codeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のCaimex Codeの準備ができました。",
  "wsl.onboarding.opencodeReady": "Caimex Codeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にCaimex Codeをインストールしてください。",
  "wsl.onboarding.installOpencode": "Caimex Codeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Codeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Caimex CodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Caimex Codeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Caimex Code Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Caimex Codeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCaimex Codeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (caimex.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: Caimex CodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Caimex Codeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCaimex Codeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Caimex Codeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCaimex Codeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Caimex Codeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Caimex Codeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Caimex Code の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Caimex Code は最新バージョンです。",
