export const dict = {
  ...
  "desktop.menu.documentation": "Caimex Code hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Caimex Code menyusi",
  ...
  "desktop.recovery.loadFailed": "Caimex Code yuklanmadi",
  "desktop.recovery.terminated": "Caimex Code oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Caimex Code javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Code oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Caimex Code yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Caimex Code’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Caimex Code da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Caimex Code da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "caimex.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Caimex Code serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Caimex Code tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Caimex Code {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Caimex Code yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Caimex Code {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Caimex Code-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Caimex Code-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Caimex Code tayyor.",
  "wsl.onboarding.installOpencodeIn": "Caimex Code-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Caimex Code-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Caimex Code WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Caimex Code-ni qayta oching.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Caimex Code ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Caimex Code jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (caimex.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Caimex Code hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Caimex Code bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Caimex Code serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Caimex Code uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Caimex Code qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Caimex Code tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Caimex Code mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Caimex Code ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Caimex Code oxirgi versiyasini ishga tushiryapsiz.",
