...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Caimex Code.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u caimex.json",
  ...
  "dialog.server.description": "Promijenite na koji se Caimex Code poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Caimex Code u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Caimex Code u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Caimex Code u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Caimex Code u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Caimex Code",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Caimex Code može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Caimex Code.",
  ...
  "help.tabs.introduction": "Radna površina Caimex Code sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Caimex Code ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Caimex Code timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (caimex.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Caimex Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Caimex Code Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Caimex Code poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Caimex Code",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Caimex Code izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Caimex Code slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Caimex Code tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Caimex Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Caimex Code.",
