export const dict = {
  ...
  "desktop.recovery.loadFailed": "Caimex Code yüklənə bilmədi",
  "desktop.recovery.terminated": "Caimex Code pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Caimex Code cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Code quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Caimex Code yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Caimex Code-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Caimex Code-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Caimex Code-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər caimex.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Caimex Code serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Caimex Code yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Caimex Code yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Caimex Code yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Caimex Code yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Caimex Code-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Caimex Code-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Caimex Code hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Caimex Code-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Caimex Code quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Caimex Code WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Caimex Code-u yenidən açın.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Caimex Code-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Caimex Code komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (caimex.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Caimex Code hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Caimex Code serverini işlət.",
  ...
  "settings.general.row.language.description": "Caimex Code üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Caimex Code-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Caimex Code-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Caimex Code-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Caimex Code açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Caimex Code-un ən son versiyasından istifadə edirsiniz.",
