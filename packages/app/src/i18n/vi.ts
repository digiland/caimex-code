export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Caimex Code",
  ...
  "desktop.recovery.loadFailed": "Không tải được Caimex Code",
  "desktop.recovery.terminated": "Cửa sổ Caimex Code đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Caimex Code không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Caimex Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Caimex Code nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Caimex Code.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong caimex.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Caimex Code mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Caimex Code trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Caimex Code trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Caimex Code trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Caimex Code trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Caimex Code có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Caimex Code ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Caimex Code",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (caimex.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Caimex Code chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Caimex Code bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Caimex Code",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Caimex Code trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Caimex Code tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Caimex Code khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Caimex Code.",
