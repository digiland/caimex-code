export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Caimex Code",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Caimex Code",
  "desktop.recovery.terminated": "La fenêtre Caimex Code s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Caimex Code ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Caimex Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Caimex Code est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Caimex Code.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans caimex.json",
  ...
  "dialog.server.description": "Changez le serveur Caimex Code auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Caimex Code dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Caimex Code dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Caimex Code dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Caimex Code dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Caimex Code puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Caimex Code ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Caimex Code",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (caimex.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Caimex Code ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Caimex Code inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Caimex Code dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Caimex Code",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Caimex Code sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Caimex Code suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Caimex Code",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Caimex Code.",
