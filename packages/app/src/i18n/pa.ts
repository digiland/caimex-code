export const dict = {
  ...
  "desktop.menu.documentation": "Caimex Code دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Caimex Code لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Caimex Code دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Caimex Code جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Code دی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ Caimex Code انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Caimex Code دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Caimex Code وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Caimex Code وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Caimex Code وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "caimex.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Caimex Code سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "Caimex Code چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ Caimex Code دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "Caimex Code نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ Caimex Code نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ Caimex Code نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "Caimex Code اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "Caimex Code تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ Caimex Code انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "Caimex Code انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Caimex Code دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Caimex Code دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Caimex Code Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Caimex Code ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Caimex Code ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (caimex.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Caimex Code ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Caimex Code سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Caimex Code لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Caimex Code کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Caimex Code سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Caimex Code نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Caimex Code لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Caimex Code دا تازہ ترین ورژن چلا رئے او۔",
