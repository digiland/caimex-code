...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Caimex Code zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Caimex Code zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Caimex Code zu nutzen.",
  ...
  "dialog.plugins.empty": "In caimex.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Caimex Code-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "Caimex Code",
  ...
  "wsl.onboarding.checkingOpencode": "Caimex Code wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Caimex Code in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Caimex Code wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Caimex Code in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Caimex Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Caimex Code aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Caimex Code ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Caimex Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Caimex Code installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Caimex Code einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Caimex Code erneut.",
  ...
  "toast.update.description": "Eine neue Version von Caimex Code ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Caimex Code-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (caimex.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Caimex Code unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Caimex Code mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Caimex Code enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Caimex Code Desktop",
  ...
  "settings.desktop.wsl.description": "Caimex Code-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Caimex Code ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Caimex Code auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Caimex Code dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Caimex Code anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Caimex Code automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Caimex Code ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Caimex Code wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Caimex Code konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Caimex Code-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Caimex Code reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Code-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Caimex Code-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Caimex Code Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
