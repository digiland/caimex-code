export const dict = {
  ...
  "desktop.menu.documentation": "Caimex Code Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Caimex Code μενού",
  ...
  "desktop.recovery.loadFailed": "Caimex Code απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Caimex Code το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Caimex Code δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Code η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Caimex Code η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Caimex Code.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο caimex.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Caimex Code συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Caimex Code σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Caimex Code σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Caimex Code σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Caimex Code στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Caimex Code να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Caimex Code ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Caimex Code",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (caimex.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Caimex Code δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Caimex Code Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Caimex Code μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Caimex Code",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Caimex Code στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Caimex Code ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Caimex Code",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Caimex Code.",
