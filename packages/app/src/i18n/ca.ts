export const dict = {
  ...
  "desktop.menu.documentation": "Caimex Code Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Caimex Code.",
  ...
  "desktop.recovery.loadFailed": "Caimex Code no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Caimex Code s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Caimex Code no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Caimex Code ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Caimex Code actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Caimex Code.",
  ...
  "dialog.plugins.empty": "Connectors configurats a caimex.json",
  ...
  "dialog.server.description": "Canvia a quin Caimex Code servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Caimex Code a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Caimex Code a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Caimex Code a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Caimex Code a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Caimex Code pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Caimex Code ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Caimex Code.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (caimex.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Caimex Code encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Caimex Code Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Caimex Code dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Caimex Code",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Caimex Code al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Caimex Code segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Caimex Code.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Caimex Code.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Caimex Code.",
