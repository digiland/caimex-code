export const dict = {
  ...
  "desktop.recovery.loadFailed": "Caimex Code laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Caimex Code aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Caimex Code ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Code installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Caimex Code värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Caimex Code'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Caimex Code.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis caimex.json",
  ...
  "dialog.server.description": "Lülitage, millise Caimex Code serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Caimex Code kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Caimex Code kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Caimex Code värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Caimex Code värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Caimex Code jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Caimex Code asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Caimex Code saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Caimex Code ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Caimex Code meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (caimex.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Caimex Code ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Caimex Code Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Caimex Code server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Caimex Code kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Caimex Code teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Caimex Code järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Caimex Code on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Caimex Code käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Caimex Code uusimat versiooni.",
