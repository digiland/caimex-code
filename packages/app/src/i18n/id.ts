export const dict = {
  ...
  "desktop.recovery.loadFailed": "Caimex Code gagal dimuat",
  "desktop.recovery.terminated": "Jendela Caimex Code berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Caimex Code tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Caimex Code gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Caimex Code selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Caimex Code.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di caimex.json",
  ...
  "dialog.server.description": "Ganti server Caimex Code mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Caimex Code di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Caimex Code di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Caimex Code di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Caimex Code di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Caimex Code dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Caimex Code ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Caimex Code",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (caimex.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Caimex Code belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Caimex Code di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Caimex Code",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Caimex Code di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Caimex Code mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Caimex Code diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Caimex Code.",
