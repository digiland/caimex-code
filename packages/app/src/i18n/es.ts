export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Caimex Code",
  ...
  "desktop.menu.ariaLabel": "Menú de Caimex Code",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Caimex Code",
  "desktop.recovery.terminated": "La ventana de Caimex Code se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Caimex Code no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Caimex Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Caimex Code finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Caimex Code.",
  ...
  "dialog.plugins.empty": "Plugins configurados en caimex.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Caimex Code al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Caimex Code en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Caimex Code en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Caimex Code en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Caimex Code en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Caimex Code pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Caimex Code ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Caimex Code",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (caimex.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Caimex Code aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Caimex Code dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Caimex Code",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Caimex Code en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Caimex Code sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Caimex Code",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Caimex Code.",
