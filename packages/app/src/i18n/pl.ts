export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Caimex Code",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Caimex Code",
  "desktop.recovery.terminated": "Okno Caimex Code zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Caimex Code nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Caimex Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Caimex Code została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Caimex Code.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku caimex.json",
  ...
  "dialog.server.description": "Przełącz serwer Caimex Code, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Caimex Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Caimex Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Caimex Code w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Caimex Code w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Caimex Code będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Caimex Code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Caimex Code",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (caimex.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Caimex Code nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Caimex Code zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Caimex Code wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Caimex Code",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Caimex Code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Caimex Code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Caimex Code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Caimex Code.",
