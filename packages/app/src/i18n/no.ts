...
export const dict = {
  ...
  "desktop.menu.documentation": "Caimex Code-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Caimex Code-meny",
  ...
  "desktop.recovery.loadFailed": "Caimex Code kunne ikke lastes inn",
  "desktop.recovery.terminated": "Caimex Code-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Caimex Code svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Caimex Code mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Caimex Code er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Caimex Code.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i caimex.json",
  ...
  "dialog.server.description": "Bytt hvilken Caimex Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Caimex Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Caimex Code-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (caimex.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Caimex Code ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Caimex Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Caimex Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Caimex Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Caimex Code skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Caimex Code starter",
  ...
  "settings.updates.toast.latest.title": "Caimex Code er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Caimex Code.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Caimex Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Caimex Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Caimex Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Caimex Code i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Caimex Code kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Caimex Code på nytt.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
