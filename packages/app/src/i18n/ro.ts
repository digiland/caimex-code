export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Caimex Code",
  ...
  "desktop.menu.ariaLabel": "Meniu Caimex Code",
  ...
  "desktop.recovery.loadFailed": "Caimex Code nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Caimex Code s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Caimex Code nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Caimex Code a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Caimex Code s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Caimex Code.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în caimex.json",
  ...
  "dialog.server.description": "Schimbă serverul Caimex Code la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Caimex Code în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Caimex Code în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Caimex Code în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Caimex Code în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Caimex Code să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Caimex Code ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Caimex Code",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (caimex.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Caimex Code nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Caimex Code în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Caimex Code",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Caimex Code pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Caimex Code urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Caimex Code",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Caimex Code.",
