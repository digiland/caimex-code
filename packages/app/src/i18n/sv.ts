export const dict = {
  ...
  "desktop.recovery.loadFailed": "Caimex Code kunde inte läsas in",
  "desktop.recovery.terminated": "Caimex Code-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Caimex Code svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Caimex Code misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Caimex Code-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Caimex Code.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i caimex.json",
  ...
  "dialog.server.description": "Växla vilken Caimex Code-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Caimex Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Caimex Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Caimex Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Caimex Code i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Caimex Code kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Caimex Code igen.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Caimex Code ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Caimex Code-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (caimex.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Caimex Code stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Caimex Code-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Caimex Code",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Caimex Code ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Caimex Code följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Caimex Codes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Caimex Code startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Caimex Code.",
