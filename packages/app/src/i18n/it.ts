export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Caimex Code.",
  ...
  "dialog.plugins.empty": "Plugin configurati in caimex.json",
  ...
  "dialog.server.description": "Cambia il server Caimex Code a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Caimex Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Caimex Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Caimex Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Caimex Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Caimex Code possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Caimex Code ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Caimex Code",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (caimex.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Caimex Code non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Caimex Code all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Caimex Code",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Caimex Code sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Caimex Code segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Caimex Code",
  ...
  "settings.updates.toast.latest.title": "Caimex Code è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Caimex Code.",
  ...
  "desktop.menu.documentation": "Documentazione di Caimex Code",
  ...
  "desktop.menu.ariaLabel": "Menu Caimex Code",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Caimex Code",
  "desktop.recovery.terminated": "La finestra di Caimex Code si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Caimex Code non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Caimex Code non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Caimex Code è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
