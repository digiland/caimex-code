...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Caimex Code failed to load",
  "desktop.recovery.terminated": "Caimex Code window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Caimex Code is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Code installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Caimex Code update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
