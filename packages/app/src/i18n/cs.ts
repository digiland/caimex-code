export const dict = {
  ...
  "desktop.menu.documentation": "Caimex Code Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Caimex Code",
  ...
  "desktop.recovery.loadFailed": "Caimex Code se nepodařilo načíst",
  "desktop.recovery.terminated": "Caimex Code okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Caimex Code nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Code instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Caimex Code aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Caimex Code.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v caimex.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Caimex Code serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Caimex Code v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Caimex Code v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Caimex Code v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Caimex Code do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Caimex Code může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Caimex Code.",
  ...
  "help.tabs.introduction": "Caimex Code Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Caimex Code ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Caimex Code",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (caimex.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Caimex Code zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Caimex Code uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Caimex Code",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Caimex Code na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Caimex Code následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Caimex Code.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Caimex Code",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Caimex Code.",
