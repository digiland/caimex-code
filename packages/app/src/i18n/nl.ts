export const dict = {
  ...
  "desktop.menu.documentation": "Caimex Code-documentatie",
  ...
  "desktop.recovery.loadFailed": "Caimex Code kan niet worden geladen",
  "desktop.recovery.terminated": "Het Caimex Code-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Caimex Code reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Caimex Code is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Caimex Code-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Caimex Code te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Caimex Code te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Caimex Code te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in caimex.json",
  ...
  "dialog.server.description": "Wijzig met welke Caimex Code-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Caimex Code controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Caimex Code controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Caimex Code bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Caimex Code bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Caimex Code bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Caimex Code bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Caimex Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Caimex Code een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Caimex Code opnieuw.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Caimex Code ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Caimex Code-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (caimex.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Caimex Code ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Caimex Code-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Caimex Code",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Caimex Code eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Caimex Code het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Caimex Code aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Caimex Code wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Caimex Code is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Caimex Code.",
