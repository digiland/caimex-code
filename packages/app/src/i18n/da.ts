export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Caimex Code.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i caimex.json",
  ...
  "dialog.server.description": "Skift hvilken Caimex Code-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Caimex Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Caimex Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Caimex Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Caimex Code kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Caimex Code igen.",
  ...
  "toast.update.description": "En ny version af Caimex Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Caimex Code-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (caimex.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Caimex Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Caimex Code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Caimex Code",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Caimex Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Caimex Code skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Caimex Codes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Caimex Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Caimex Code.",
  ...
  "desktop.recovery.loadFailed": "Caimex Code kunne ikke indlæses",
  "desktop.recovery.terminated": "Caimex Code-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Caimex Code mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Caimex Code er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Caimex Code Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
