export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Caimex Codessa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Caimex Codessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Caimex Codessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään caimex.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Caimex Code-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Caimex Codea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Caimex Codea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Caimex Codea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Caimex Codea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Caimex Code jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Caimex Code jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Codea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Caimex Code voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Caimex Code uudelleen.",
  ...
  "toast.update.description": "Caimex Coden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Caimex Code-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (caimex.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Caimex Code ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Caimex Code-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Caimex Coden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Caimex Code näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Caimex Code järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Caimex Coden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Caimex Code käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Caimex Coden uusinta versiota.",
  ...
  "desktop.menu.documentation": "Caimex Code-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Caimex Code-valikko",
  ...
  "desktop.recovery.loadFailed": "Caimex Coden lataaminen epäonnistui",
  "desktop.recovery.terminated": "Caimex Code-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Caimex Code ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Coden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Codea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Caimex Coden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Caimex Code Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
