export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Caimex Code",
  ...
  "desktop.menu.ariaLabel": "Menu do Caimex Code",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Caimex Code",
  "desktop.recovery.terminated": "A janela do Caimex Code foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Caimex Code não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Caimex Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Caimex Code não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Caimex Code foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Caimex Code.",
  ...
  "dialog.plugins.empty": "Plugins configurados em caimex.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Caimex Code este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Caimex Code em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Caimex Code em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Caimex Code em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "O Caimex Code está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Caimex Code está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Caimex Code em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Caimex Code possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Caimex Code não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Caimex Code novamente.",
  ...
  "help.tabs.introduction": "Agora, o Caimex Code Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Caimex Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Caimex Code",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (caimex.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Caimex Code ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Caimex Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Caimex Code",
  ...
  "settings.general.row.appearance.description": "Personalize como o Caimex Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Caimex Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Caimex Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Caimex Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Caimex Code.",
  ...
  "toast.session.export.failed.title": "Falha ao exportar a sessão",
