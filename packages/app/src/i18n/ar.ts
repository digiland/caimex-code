export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Caimex Code",
  "desktop.recovery.terminated": "توقفت نافذة Caimex Code بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Caimex Code لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Caimex Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Caimex Code، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Caimex Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Caimex Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Caimex Code.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في caimex.json",
  ...
  "dialog.server.description": "تبديل خادم Caimex Code الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Caimex Code في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Caimex Code في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Caimex Code في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Caimex Code جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Caimex Code في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Caimex Code من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Caimex Code التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Caimex Code.",
  ...
  "help.tabs.introduction": "أصبح Caimex Code Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Caimex Code ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Caimex Code",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (caimex.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Caimex Code لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Caimex Code نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Caimex Code داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Caimex Code",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Caimex Code على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Caimex Code يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Caimex Code.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Caimex Code",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Caimex Code.",
