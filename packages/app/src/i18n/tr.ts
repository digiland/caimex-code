...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Caimex Code yüklenemedi",
  "desktop.recovery.terminated": "Caimex Code penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Caimex Code yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Code kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Caimex Code güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Caimex Code'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Caimex Code'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Caimex Code'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler caimex.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Caimex Code sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Caimex Code kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Caimex Code kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Caimex Code güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Caimex Code güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Caimex Code'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Caimex Code'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Caimex Code hazır.",
  "wsl.onboarding.opencodeReady": "Caimex Code hazır.",
  "wsl.onboarding.installOpencodeIn": "Caimex Code'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Caimex Code'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Caimex Code'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Caimex Code'u tekrar açın.",
  ...
  "help.tabs.introduction": "Caimex Code Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Caimex Code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Caimex Code ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (caimex.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Caimex Code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Caimex Code ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Caimex Code Masaüstü",
  ...
  "settings.desktop.wsl.description": "Caimex Code sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Caimex Code'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Caimex Code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Caimex Code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Caimex Code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Caimex Code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Caimex Code'un en son sürümünü kullanıyorsunuz.",
