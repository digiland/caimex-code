export const dict = {
  ...
  "desktop.menu.documentation": "Caimex Code Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Caimex Code մենյու",
  ...
  "desktop.recovery.loadFailed": "Caimex Code չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Caimex Code պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Caimex Code-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "Caimex Code տեղադրումը ձախողվեց",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Caimex Code տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Caimex Code թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Caimex Code-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Caimex Code-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Caimex Code-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են caimex.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Caimex Code սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է Caimex Code...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է Caimex Code-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է Caimex Code...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է Caimex Code-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել Caimex Code-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել Caimex Code",
  "wsl.onboarding.opencodeReadyIn": "Caimex Code պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "Caimex Code պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Caimex Code-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք Caimex Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Caimex Code տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Caimex Code-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Caimex Code-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Caimex Code։",
  ...
  "help.tabs.introduction": "Caimex Code Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Caimex Code-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Caimex Code թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (caimex.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Caimex Code-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Caimex Code ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Caimex Code սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Caimex Code",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Caimex Code տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Caimex Code-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Caimex Code-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Caimex Code-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Caimex Code-ի վերջին տարբերակը։",
