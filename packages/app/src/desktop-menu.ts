...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    items: [
      { type: "item", labelKey: "desktop.menu.documentation", href: "https://caimex.econetai.co.zw/docs" },
      { type: "item", labelKey: "desktop.menu.supportForum", href: "https://github.com/digiland/caimex-code/discussions" },
      { type: "item", labelKey: "desktop.menu.exportLogs", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        labelKey: "desktop.menu.shareFeedback",
        href: "https://github.com/digiland/caimex-code/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        labelKey: "desktop.menu.reportBug",
        href: "https://github.com/digiland/caimex-code/issues/new?template=bug_report.yml",
      },
    ],
  },
]
