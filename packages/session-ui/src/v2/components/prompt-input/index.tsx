      ...
      >
        ...
        <div class="relative min-h-[60px]">
          <div
            ...
            // @ts-expect-error
            autocomplete="off"
            // String.raw keeps the literal `\200B` in source so Tailwind extracts the same
            // utility name, while avoiding the octal-escape parse error a plain string yields.
